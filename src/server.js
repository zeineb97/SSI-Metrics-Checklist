...
var sstache11= await createSousTache({
  clause : "clause 6.1.3.3",
       date_debut : "2022-01-10T23:00:00.000Z",
        ...
        etat : "pas mis en oeuvre",
        label : "Comparer les contrôles déterminés au 6.1.3 (b) ci-dessus avec ceux de l'annexe A et vérifier qu'aucun contrôle nécessaire n'a été omis"
});
...
var sstache12= await createSousTache({
  ...
  date_debut : "2022-01-11T23:00:00.000Z",
   ...
   etat : "pas mis en oeuvre",
   label : "Produire une déclaration d'applicabilité contenant les contrôles nécessaires (voir 6.1.3.b et c) et la justification des inclusions, qu'elles soient mises en œuvre ou non, et la justification des exclusions des contrôles de l'annexe A"
});
